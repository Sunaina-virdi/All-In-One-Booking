    ...
    return (
      <header className='flex justify-between'>
        <Link to={'/'} className='flex items-center gap-1'>
          ...
          <span className='font-bold text-xl '>Allin1</span>
        </Link>
        <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-blue-800'>
          ...
          <div className='border-l border-gray-300' ></div>
          <div>Add guests</div>
          <button className='bg-blue-800 text-white p-1 rounded-full'>
        ...
        className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-blue-800">
          <input
            type="text"
